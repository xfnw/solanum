...
extern bool sendto_one_multiline_init(struct Client *target_p, const char *separator, const char *format, ...) AFP(3, 4);
extern bool sendto_one_multiline_remote_extra_space(struct Client *target_p, struct Client *client_p);
extern enum multiline_item_result sendto_one_multiline_item(struct Client *target_p, const char *format, ...) AFP(2, 3);
extern bool sendto_one_multiline_fini(struct Client *target_p, const char *format, ...) AFP(2, 3);
extern void sendto_one_multiline_reset(void);
